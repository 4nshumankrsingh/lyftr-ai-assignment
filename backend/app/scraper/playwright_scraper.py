        ...
        try:
            async with async_playwright() as p:
                ...
                if 'news.ycombinator.com' in url or 'hacker-news.com' in url:
                    logger.info("🟡 HACKER NEWS DETECTED - ENSURING INTERACTIONS")
                    ...
                    if len(clicks) + scrolls < 3:
                        logger.info("🔧 FORCING MINIMUM INTERACTIONS FOR HACKER NEWS")
                ...
                if 'news.ycombinator.com' in url or 'hacker-news.com' in url:
                    logger.info("🎯 APPLYING FINAL HACKER NEWS INTERACTION GUARANTEE")
                    ...
                    logger.info(f"✅ FINAL Hacker News interactions guaranteed: "
